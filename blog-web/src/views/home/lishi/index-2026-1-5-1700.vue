  ...
  <div id="">
    <el-container style="height: 100vh; overflow: hidden;">
      ...
      <el-container style="height: 100vh;">
        ...
        <el-main class="main-content" style="height: calc(100vh - 120px);">
          <!-- Markdown内容显示区域 -->
          <div class="markdown-container" v-if="currentContent.content || currentContent.markdown">
            ...
            <div v-if="isEditingContent" class="content-editor">
              ...
              <mavon-editor
                ...
                style="height: calc(100vh - 300px); margin-top: 20px;"
              />
          ...
          <div v-else class="default-content">
            ...
            <div class="content-section">
              ...
              <p class="section-text">WaytoAGI知识库内 9000+ 篇AI内容，现已支持【飞书知识库】功能！</p>
              <div class="feature-list">
                <span class="feature-item">📋 你问问题</span>
                <span class="feature-item">→ 🤖 AI理解</span>
                <span class="feature-item">→ 📊 智能总结</span>
                <span class="feature-item">→ 🔍 精准溯源</span>
              </div>
              <p class="section-text">以前翻译半天找不到想要的资料，现在一句话即可出现想要的高质量内容答复!</p>
              <div class="cta-section">
                <p class="cta-text">
                  <span class="rocket-icon">🚀</span>
                  <span>增加入口（需先点击【加入人选对话】再抽问） </span>
                  <span class="link-emoji">👉 飞书空间咨询圈子</span>
                </p>
                <p class="warning-text">
                  <span class="warning-icon">⚠️</span>
                  诚邀测评：欢迎加入右侧体验群，不喜欢推点击咱，还是想牛场，均可在群内反馈！
                </p>
              </div>
...
export default {
  ...
  created() {
    this.getAijsqMenuList();
  },
  methods: {
    // 转换函数，将您的菜单数据转换成vue-treeselect需要的格式
    transformToTreeSelectOptions(menuItems) {
      return menuItems.map(item => {
        ...
        if (item.children && item.children.length > 0) {
          node.children = this.transformToTreeSelectOptions(item.children)
        }
        return node
      })
    },
    // 自定义normalizer，根据您的数据结构调整
    normalizer(node) {
      // 去掉children = null的属性
    ...
    handleSpecialMenu(type) {
      ...
      this.currentContent = {
        title: '通往AGI之路',
        markdown: `# 通往AGI之路\n\n## 社区数据\n- 成员: 2438364\n- 学习时长: 5200661\n- 课程: 2939\n- 合作伙伴: 715\n\n## 核心目标\n让每个人在AI时代都不掉队！\n\n## 社区特色\n\n### 系统学习路径\n我们提供了从入门到精通的完整学习路线，涵盖了AI的各个领域。\n\n### 丰富的实践项目\n通过实际项目帮助学习者巩固知识，提升实践能力。\n\n### 活跃的社区交流\n在社区中与志同道合的学习者交流，共同进步。\n\n## 最新动态\n\n### 新功能上线\n- 知识库问答功能现已全面开放\n- 新增了AI绘画工作流教程\n- 优化了移动端使用体验\n\n### 社区活动\n- 本周六晚8点：AI应用开发线上分享会\n- 下周三：AGI技术趋势讲座\n- 每月定期：项目展示交流会\n\n## 快速开始\n\n1. **注册账号**：创建你的个人账户\n2. **选择学习路径**：根据兴趣选择合适的学习路线\n3. **加入社区**：参与讨论和项目协作\n4. **持续学习**：跟随进度，不断提升\n\n## 资源推荐\n\n### 入门必读\n- 《AI基础知识入门》\n- 《深度学习简明教程》\n- 《机器学习实践指南》\n\n### 进阶学习\n- 《神经网络与深度学习》\n- 《自然语言处理实战》\n- 《计算机视觉应用开发》\n\n### 专家资源\n- 《强化学习前沿》\n- 《生成式AI技术解析》\n- 《AGI发展路径探讨》`
      }
      this.breadcrumb = [{ id: 'agi-road', title: '通往AGI之路' }]
    },
    
    // 处理子菜单点击
    async handleSubMenuClick(menuItem) {
      try {
        const { data } = await getDetailByMenuIdApi(menuItem.id)
    ...
    loadContent(menuItem) {
      this.currentContent = {
        ...
        markdown: menuItem.contentMd || '# ' + menuItem.title + '\n\n内容正在建设中...',
...
.default-content::-webkit-scrollbar-track {
  background: #f5f5f5;
  border-radius: 4px;
}
...
.default-content::-webkit-scrollbar-thumb {
  background: #c1c1c1;
  border-radius: 4px;
}
...
.default-content::-webkit-scrollbar-thumb:hover {
  background: #a8a8a8;
}
...
@media print {
  ...
  .markdown-preview,
  .markdown-preview .v-note-wrapper {
    box-shadow: none !important;
    height: auto !important;
  }
}

/* 修复mavon-editor在滚动时的显示 */
.v-note-wrapper {
...
.v-note-wrapper .v-note-edit.divarea {
